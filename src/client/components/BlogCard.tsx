                ...
                <div className="card col-12 mb-4" >
                    ...
                    <div className="card-footer text-muted d-flex justify-content-between">
                        ...
                        <button data-tip="Go Back" id="buttonSingle" className="btn shadow" onClick={() => history.goBack()}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-arrow-back" width="25" height="25" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#7e858d" fill="none" strokeLinecap="round" strokeLinejoin="round">
